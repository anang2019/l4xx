...
GK.PointGlobeDrawable = function(){
    ...
    this.init = function() {
        ...
        texture = GK.TextureManager.loadTexture("/public/index/img/texture/dot.png", true, gl.CLAMP_TO_EDGE, gl.CLAMP_TO_EDGE);
        noiseTexture = GK.TextureManager.loadTexture("/public/index/img/texture/clouds.png", true, gl.REPEAT, gl.REPEAT);
        return this;
    }
